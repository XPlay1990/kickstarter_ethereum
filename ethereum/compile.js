...
function createConfiguration() {
    return {
        language: 'Solidity',
        sources: {
            'KickstarterCampaignFactory.sol': {
                content: fs.readFileSync(path.resolve(__dirname, 'contracts', 'KickstarterCampaignFactory.sol'), 'utf8')
            },/*
...
function getImports(dependency) {
    ...
    switch (dependency) {
        case 'KickstarterCampaign.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contracts', 'KickstarterCampaign.sol'), 'utf8')};
        case 'KickstarterCampaignFactory.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, 'contracts', 'KickstarterCampaignFactory.sol'), 'utf8')};
